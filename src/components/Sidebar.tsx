...
const Sidebar: React.FunctionComponent<SidebarProps> = () => {
    ...
    return (
        <main className="border-2 border-transparent px-5 py-10">
            <Link href={`/contact`}>
                <div className="contact mb-4 border-2 border-spgray p-1">
                        <Contact2 className="dark:text-white" />
                </div>
            </Link>
            <Link className="!cursor-default" href={`https://www.facebook.com/yassineWebDev`} target="_blank">
                <div className="fb mb-4 border-2 border-spgray p-1">
            ...
            <Link className="!cursor-default" href={`https://www.instagram.com/yassine_web_dev?utm_source=qr`} target="_blank">
                <div className="ig mb-4 border-2 border-spgray p-1">
            ...
            <Link className="!cursor-default" href={`https://www.linkedin.com/in/yassine-lemkhayer-007a69261/`} target="_blank">
                <div className="ln border-2 border-spgray p-1">
