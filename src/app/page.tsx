    ...
    <main className='container flex xl:gap-60 pb-52'>
      ...
      <div className="what-i-do pt-72 xl:pt-64">
        <div>
          ...
          <Link href={`/projects`}>
            <button type="button" className="mt-8 mb-2 sm:mb-0 mr-4 text-black bg-white border-[1px] border-[#dadada] hover:bg-[#dadada] font-medium rounded-lg text-base px-5 py-2.5">Projects</button>
          </Link>
